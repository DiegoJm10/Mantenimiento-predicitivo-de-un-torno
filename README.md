...
8. En la siguiente lista se mostrara los códigos de cada fuction:
   ...
   Se instalaron los drivers para esp32 en Arduino IDE.
...
Buscamos esp32 y seleccionamos lo que muestra en la imagen 
.
Se seleccionó la tarjeta adecuada la cual se llama ESP32 Dev Module.

Se realizaron los códigos por separado para poder obtener un mejor resultado.

Empezamos haciendo el código del termopar tipo K.
...
Se realizo el codigo de el sensor sct 013.
// Instalacion de Librerias
#include <Adafruit_GFX.h>
#include <Adafruit_PCD8544.h>
#include "EmonLib.h"
...
Se juntaron todos los codigos con el codigo de conexion a internet
#include <Adafruit_GFX.h>
#include <Adafruit_PCD8544.h>
#include "EmonLib.h"
#include <SPI.h>
...
Mostramos la conexión de Node-red...
.
En la siguiente lista se mostrara los códigos de cada fuction:
   - Fuction 1:
    ```
    msg.topic = "SELECT * FROM tamulba7 ORDER BY FECHA DESC";
    msg.leer = true;
